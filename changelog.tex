...
\textbf{Status:} Code complete. Awaiting execution.
...
\texttt{train.py}              & da2$\to$da3 renames, \texttt{-{}-freeze-encoder}; Iter 6: \texttt{-{}-uncertainty-weighting}, per-task checkpoints; Iter 7: \texttt{-{}-dataset} flag \\
