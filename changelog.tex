...
\begin{itemize}[nosep]
  \item \textbf{Depth RMSE:} 0.572\,m (V4: 0.774\,m, Iter 6: 0.998\,m)
  ...
  \item \textbf{All classes improved:} person $+17$pp, glass $+21$pp,
    floor 86\%, wall 80\%, furniture 76\%
\end{itemize}

\textbf{Cumulative improvement from Vivek's experiments:}
\begin{itemize}[nosep]
...
\textbf{Status:} V5 training and evaluation complete. Model ready for
ONNX export, TensorRT deployment on Jetson, and corridor fine-tuning.
