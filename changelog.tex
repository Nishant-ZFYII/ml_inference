...
\textbf{Status:} Teacher inference must be re-run first (all 1449 images),
then training. Results pending.
...
Feb 28, 2026 & Iter 5: full-dataset teachers (all 1449), pure distillation (pending) \\
\bottomrule
\end{longtable}
